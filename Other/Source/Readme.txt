...
user in an INI file next to JurisMPortable.exe called JurisMPortable.ini.
...
copy JurisMPortable.ini from this directory to JurisMPortable.ini next to
JurisMPortable.exe. The options in the INI file are as follows:
...
JurisMPortable.ini file. This option directs Portable Juris-M to be started with
the -no-remote flag, which disrupts communication between Juris-M and the 
